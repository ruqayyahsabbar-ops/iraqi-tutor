...
# التحقق من القبول وربط مفتاح API من إعدادات Secrets في Streamlit
...
# زر إرسال السؤال والتفاعل الأساسي
if st.button("🚀 إرسال", type="primary"):
    if not user_question.strip() and not uploaded_image:
        ...
        with st.spinner("... جاري التفكير والبحث في المنهج الدراسي"):
            try:
                # استخدام نموذج يدعم الرؤية والنصوص
                ...
                # حفظ الإجابة في الذاكرة المؤقتة للجلسة لنستعملها في الامتحان
